...
var todoShow = document.querySelector("#todo-show");
var todoForm = document.getElementById("todo-form");
var todoInput = todoForm.querySelector("#todo-form input");
...
function deleteTodo(event) {
  var li = event.target.parentElement; // 클릭된 (event) target (버튼) 의 parentElement(부모요소 (text)) 를 li 에 저장후 삭제
  li.remove();
...
function paintToDo(newTodo) {
  var li = document.createElement("li"); // 요소 추가 하기
  li.id = newTodo.id;
...
function handleToDoSubmit(event) {
  ...
  var newTodo = todoInput.value; // input의 값 저장 하기
