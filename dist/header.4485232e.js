...
var startBtn = headerEl.querySelector(".menuBtn");
var headerMenu = document.querySelector(".menu-bar");
var openBtn = '<i class="fa-solid fa-forward fa-2xl"></i>';
var closeBtn = '<i class="fa-solid fa-backward fa-2xl"></i>';
var flag = true;
